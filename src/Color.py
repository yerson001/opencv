...
cv2.createTrackbar("canny", "HSV", 0,   5, nothing)
cv2.createTrackbar("dilate", "HSV", 0,   5, nothing)



cap  = cv2.VideoCapture("/home/y3rsn/Videos/Webcam/myvideo.webm")
# cap  = cv2.imread("/home/y3rsn/Videos/myvideo.mp4")
cap.set(3,width)
cap.set(4,height)
...
while True:
    ...
    cn = cv2.getTrackbarPos("canny", "HSV")
    dt = cv2.getTrackbarPos("dilate", "HSV")
